...
class _DetailScreenState extends ConsumerState<DetailScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text(
                                'Attribution: https://unsplash.com/?utm_source=nature_pix&utm_medium=referral',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
  ...
  Future<void> _download() async {
    ...
    try {
      final filePath = await _ensureLocalFile();
      await Gal.putImage(filePath, album: 'NaturePix');
      if (mounted) {
        setState(() => _isBusy = false);
  ...
  Future<String> _ensureLocalFile() async {
    ...
    final filePath = '${dir.path}/naturepix_${widget.wallpaper.id}.jpg';
